...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['location']) && isset($_POST['product']) && isset($_POST['count_adjustment'])) {
        ...
        try {
            ...
            echo "<div class='alert alert-danger'>Fout bij het bijwerken: " . $ex->getMessage() . "</div>";
        }
    }
}
...
if (isset($_GET['location'])) {
    ...
    try {
        ...
        echo "<div class='alert alert-danger'>Fout bij het ophalen van producten: " . $ex->getMessage() . "</div>";
    }
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="../css/AdminUser/count.css"> <!-- Specifieke styling voor count -->
</head>
<body>
<!-- Navbar -->
<header class="navbar">
...
<main class="main-container">
    <h1 class="page-title">Locatie opslag</h1>
