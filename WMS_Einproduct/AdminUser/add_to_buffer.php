...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($stock && $stock['quantity'] >= $quantity) {
            ...
            echo "<div class='alert alert-success'>Product succesvol toegevoegd aan buffer!</div>";
        } else {
            echo "<div class='alert alert-danger'>Onvoldoende voorraad in `unloaded_stock` of product niet beschikbaar.</div>";
        }
    } catch (Exception $e) {
        echo "<div class='alert alert-danger'>Er ging iets mis: " . htmlspecialchars($e->getMessage()) . "</div>";
    }
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="../css/AdminUser/add_to_buffer.css"> <!-- Specifieke styling voor add_to_buffer -->
</head>
<body>
<!-- Navbar -->
<header class="navbar">
...
<main class="main-container">
    <h1 class="page-title">Product Toevoegen aan Buffer</h1>

    <!-- Formulier voor product toevoegen aan buffer -->
