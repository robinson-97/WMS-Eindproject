...
<head>
    ...
    <link rel="stylesheet" href="../css/main.css"> <!-- Gebruik de bestaande main.css -->
    <link rel="stylesheet" href="../css/AdminUser/recieve.css"> <!-- Externe stylesheet voor po_list specifieke stijlen -->
</head>
<body>
<header class="navbar">
